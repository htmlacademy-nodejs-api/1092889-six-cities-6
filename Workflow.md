...
В процессе запуска проекта будет выполнен процесс «Сборки проекта» и запуска результирующего кода а также добавление прав на исполнение. 
...
npm run start:dev
```
Проект будет запущен с удобочитаемым выводом логов в консоль
